...
describe('Rutas de transacciones', () => {
   ...
   test('debería obtener una transacción por ID', async () => {
        const transaction = await Transaction.create({ Type: 'hunter', name_transactor: 'Hunter1', goods: [{ good: 'ESPADA', quantity: 2 }], totalAmount: 400, date: '05-05-2025', hour: '8:00' });
