...
export const getAllMerchants: RequestHandler = async (req, res) => {
  try {
...
export const getMerchantByName: RequestHandler = async (req, res) => {
  try {
...
export const updateMerchantById: RequestHandler = async (req, res) => {
  try {
    const { id } = req.params;
...
export const updateMerchantByName: RequestHandler = async (req, res) => {
  try {
    const { name } = req.query;
    const nameString = Array.isArray(name) ? name[0] : name;
...
export const deleteMerchantById: RequestHandler = async (req, res) => {
  try {
    const { id } = req.params;
...
export const deleteMerchantByName: RequestHandler = async (req, res) => {
  try {
    const { name } = req.query;
    const nameString = Array.isArray(name) ? name[0] : name;
